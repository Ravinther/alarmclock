...
public class C0069f extends Fragment implements OnCancelListener, OnDismissListener {
    ...
    public void show(C0075i manager, String tag) {
        ...
        C0066l ft = manager.m262a();
        ft.m186a((Fragment) this, tag);
        ft.m188b();
    }

    public int show(C0066l transaction, String tag) {
        this.mDismissed = false;
        this.mShownByMe = true;
        transaction.m186a((Fragment) this, tag);
        this.mViewDestroyed = false;
        this.mBackStackId = transaction.m188b();
    ...
    void dismissInternal(boolean allowStateLoss) {
        if (!this.mDismissed) {
            ...
            if (this.mBackStackId >= 0) {
                getFragmentManager().m263a(this.mBackStackId, (int) STYLE_NO_TITLE);
                this.mBackStackId = -1;
                return;
            }
            C0066l ft = getFragmentManager().m262a();
            ft.m185a((Fragment) this);
            if (allowStateLoss) {
                ft.m191c();
            } else {
                ft.m188b();
