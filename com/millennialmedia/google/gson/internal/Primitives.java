...
public final class Primitives {
    ...
    public static Class wrap(Class type) {
        Class wrapped = (Class) PRIMITIVE_TO_WRAPPER_TYPE.get(C$Gson$Preconditions.checkNotNull(type));
        return wrapped == null ? type : wrapped;
    }

    public static Class unwrap(Class type) {
        Class unwrapped = (Class) WRAPPER_TO_PRIMITIVE_TYPE.get(C$Gson$Preconditions.checkNotNull(type));
