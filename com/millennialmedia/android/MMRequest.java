...
public final class MMRequest {
    ...
    void getUrlParams(Map paramsMap) {
        ...
        if (this.orientation != null) {
            paramsMap.put(KEY_ORIENTATION, this.orientation);
        }
    ...
    public void setOrientation(String sexualOrientation) {
        this.orientation = sexualOrientation;
    }
    ...
    public void setMetaValues(Map metaData) {
        if (metaData != null) {
    ...
    static void insertLocation(Map paramsMap) {
        if (location != null) {
