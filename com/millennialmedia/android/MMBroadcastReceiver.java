...
public class MMBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (context.getPackageName().equals(packageName)) {
            ...
            Log.m9723v(" @@ Intent - Ad in receiver = " + (ad == null ? " null" : ad.toString()));
    ...
    public void getAdSuccess(MMAd ad) {
        Log.m9717i("Millennial Media ad Success.");
    }

    public void getAdFailure(MMAd ad) {
        Log.m9717i("Millennial Media ad Failure.");
    }

    public void overlayOpened(MMAd ad) {
        Log.m9717i("Millennial Media overlay opened.");
    }

    public void overlayClosed(MMAd ad) {
        Log.m9717i("Millennial Media overlay closed.");
    }

    public void intentStarted(MMAd ad, String intent) {
        if (intent != null) {
            Log.m9717i("Millennial Media started intent: " + intent);
        }
    }

    public void fetchStartedCaching(MMAd ad) {
        Log.m9717i("Millennial Media fetch started caching.");
    }

    public void fetchFinishedCaching(MMAd ad) {
        Log.m9717i("Millennial Media fetch finished caching.");
    }

    public void fetchFailure(MMAd ad) {
        Log.m9717i("Millennial Media fetch failed.");
    }

    public void displayStarted(MMAd ad) {
        Log.m9717i("Millennial Media display started.");
    }

    @Deprecated
    public void overlayTap(MMAd ad) {
        Log.m9717i("Millennial Media overlay Tap.");
    }

    public void onSingleTap(MMAd ad) {
        Log.m9717i("Millennial Media ad Tap.");
    }
}
