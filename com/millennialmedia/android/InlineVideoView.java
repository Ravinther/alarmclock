...
class InlineVideoView extends VideoView implements Serializable {
    ...
    static class InlineParams {
        ...
        InlineParams(HashMap parameters, Context context) {
            this.isInitialPlayBack = true;
            if (parameters.get("x") != null) {
                this.f4303x = (int) Float.parseFloat((String) parameters.get("x"));
            }
            if (parameters.get("y") != null) {
                this.f4304y = (int) Float.parseFloat((String) parameters.get("y"));
            }
        ...
        public String toString() {
            return String.format("%s id, %d x, %d y, %d bWidth, %d bHeight, %d pos, %b autoPlay", new Object[]{this.cachedVideoID, Integer.valueOf(this.f4303x), Integer.valueOf(this.f4304y), Integer.valueOf(this.bodyWidth), Integer.valueOf(this.bodyHeight), Integer.valueOf(this.currentPosition), Boolean.valueOf(this.autoPlay)});
        }

        void inflateFromGson(String gson) {
            InlineParams params = (InlineParams) new Gson().fromJson(gson, InlineParams.class);
            this.f4303x = params.f4303x;
            this.f4304y = params.f4304y;
            ...
            Log.m9711d("gson*****" + gson);
            Log.m9711d("PARAMS*****" + params);
        }
    }
        ...
        public void setAnchorView(View view) {
            ...
            if (this.inDrawable == null) {
                try {
                    ...
                    Log.m9714e("Exception image:" + e.getMessage());
                }
            }
            if (this.outDrawable == null) {
                try {
                    ...
                    Log.m9714e("Exception image:" + e2.getMessage());
                }
            }
            InlineVideoView inlineView = (InlineVideoView) this.inlineVideoRef.get();
            if (inlineView != null) {
    ...
    public RelativeLayout.LayoutParams getCustomLayoutParams() {
        ...
        lp.topMargin = (int) (this.inlineParams.scaleFactor * ((float) this.inlineParams.f4304y));
        lp.leftMargin = (int) (this.inlineParams.scaleFactor * ((float) this.inlineParams.f4303x));
        Log.m9711d("lp height = " + lp.height);
        return lp;
    }
    ...
    void setAdjustVideoParams(InlineParams parameters) {
        this.inlineParams.f4303x = parameters.f4303x;
        this.inlineParams.f4304y = parameters.f4304y;
    ...
    synchronized void initInlineVideo(InlineParams parameters) {
        ...
        if (isValid()) {
            ...
            Log.m9714e("The videoURI attribute was not specified on the video marker div.");
        }
    }
    ...
    private void initInternalInlineVideo() {
        ...
        Log.m9714e("Finished inserting inlineVideo player");
    }
    ...
    synchronized boolean adjustVideo(InlineParams params) {
        ...
        Log.m9714e("Called initInlineVideo inside reposition section code");
    ...
    boolean onTouch(View v, MotionEvent event) {
        if (event.getAction() == 1) {
            MMLayout mmLayout = (MMLayout) this.mmLayoutRef.get();
            if (mmLayout == null) {
                Log.m9726w("MMLayout weak reference broken");
                return false;
            }
    ...
    void updateVideoSeekTimeFinal() {
        if (this.duration > 0) {
            Log.m9711d("Time is " + this.duration);
