...
class AdViewOverlayView extends MMLayout {
    ...
    /* renamed from: com.millennialmedia.android.AdViewOverlayView.1 */
    class C24391 implements OnClickListener {
        C24391() {
        }

        public void onClick(View view) {
            Log.m9723v("Close button clicked.");
            AdViewOverlayView.this.finishOverlayWithAnimation();
        }
    }

    /* renamed from: com.millennialmedia.android.AdViewOverlayView.2 */
    class C24402 implements Runnable {
        C24402() {
        }
    ...
    class AdViewOverlayViewMMAdImpl extends MMLayoutMMAdImpl {
        ...
        MMWebViewClient getMMWebViewClient() {
            Log.m9711d("Returning a client for user: OverlayWebViewClient, adimpl=" + AdViewOverlayView.this.adImpl);
    ...
    private static class AnimationListener implements android.view.animation.Animation.AnimationListener {
        ...
        public void onAnimationEnd(Animation animation) {
            ...
            if (overlayView != null) {
                ...
                Log.m9711d("Finishing overlay this is in w/ anim finishOverLayWithAnim()");
                activity.finish();
            }
        }
    ...
    static class SavedState extends BaseSavedState {
        ...
        /* renamed from: com.millennialmedia.android.AdViewOverlayView.SavedState.1 */
        static class C24411 implements Creator {
            C24411() {
            }
    ...
    AdViewOverlayView(AdViewOverlayActivity overlayActivity, OverlaySettings settingsIn) {
        ...
        if (overlayActivity.activity instanceof Activity) {
            ...
            if (nonConfigurationInstance != null) {
                ...
                Log.m9711d("Restoring configurationinstance w/ controller= " + nonConfigurationInstance.controller);
            } else {
                Log.m9711d("Null configurationinstance ");
            }
        }
    ...
    private Button initMRaidCloseButton(Context context, float scale) {
        ...
        mraidCloseButton.setOnClickListener(new C24391());
    ...
    Object getNonConfigurationInstance() {
        if (this.adImpl != null) {
            Log.m9711d("Saving getNonConfigurationInstance for " + this.adImpl);
