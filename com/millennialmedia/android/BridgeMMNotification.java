...
class BridgeMMNotification extends MMJSObject implements OnClickListener {
    ...
    /* renamed from: com.millennialmedia.android.BridgeMMNotification.1 */
    class C24601 implements Callable {
        final /* synthetic */ HashMap val$arguments;

        C24601(HashMap hashMap) {
        ...
        public MMJSResponse call() {
            ...
            if (mmWebView != null) {
                ...
                HashMap finalArguments = this.val$arguments;
                if (activity != null) {
    ...
    public synchronized MMJSResponse alert(HashMap arguments) {
        return runOnUiThreadFuture(new C24601(arguments));
    }

    public MMJSResponse vibrate(HashMap arguments) {
