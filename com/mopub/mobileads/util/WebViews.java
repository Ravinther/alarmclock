...
public class WebViews {
    ...
    /* renamed from: com.mopub.mobileads.util.WebViews.1 */
    static class C26361 extends WebChromeClient {
        C26361() {
        }

        public boolean onJsAlert(WebView view, String url, String message, JsResult result) {
            Log.d(WebViews.LOGTAG, message);
            return true;
        }
    ...
    public static void setDisableJSChromeClient(WebView webView) {
        webView.setWebChromeClient(new C26361());
    }
}
