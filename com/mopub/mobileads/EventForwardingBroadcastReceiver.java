...
class EventForwardingBroadcastReceiver extends BroadcastReceiver {
    ...
    static void broadcastAction(Context context, long broadcastIdentifier, String action) {
        ...
        C0022i.m108a(context.getApplicationContext()).m113a(intent);
    }
    ...
    public void register(Context context) {
        ...
        C0022i.m108a(this.mContext).m112a(this, sIntentFilter);
    }

    public void unregister() {
        if (this.mContext != null) {
            C0022i.m108a(this.mContext).m111a((BroadcastReceiver) this);
            this.mContext = null;
        }
    }
}
