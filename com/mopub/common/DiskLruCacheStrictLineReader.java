...
class DiskLruCacheStrictLineReader implements Closeable {
    ...
    /* renamed from: com.mopub.common.DiskLruCacheStrictLineReader.1 */
    class C25771 extends ByteArrayOutputStream {
        C25771(int x0) {
            super(x0);
        }
    ...
    public DiskLruCacheStrictLineReader(InputStream in, Charset charset) {
        this(in, HttpClientFactory.SOCKET_SIZE, charset);
    }
    ...
    public String readLine() {
        ...
        synchronized (this.in) {
            ...
            ByteArrayOutputStream out = new C25771((this.end - this.pos) + 80);
            loop1:
            while (true) {
