...
public interface cn extends IInterface {
    ...
    public static abstract class C1800a extends Binder implements cn {

        /* renamed from: com.google.android.gms.internal.cn.a.a */
        private static class C1801a implements cn {
            private IBinder kn;
        ...
        public static cn m8057o(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof cn)) ? new C1801a(iBinder) : (cn) queryLocalInterface;
        }
