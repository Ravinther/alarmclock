...
public interface gz extends IInterface {
    ...
    public static abstract class C1934a extends Binder implements gz {

        /* renamed from: com.google.android.gms.internal.gz.a.a */
        private static class C1933a implements gz {
            private IBinder kn;

            C1933a(IBinder iBinder) {
                this.kn = iBinder;
            }
        ...
        public static gz m8626V(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.location.internal.IGeofencerCallbacks");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof gz)) ? new C1933a(iBinder) : (gz) queryLocalInterface;
        }
