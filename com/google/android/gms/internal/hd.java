...
public class hd implements SafeParcelable, Geofence {
    ...
    private static void m8686a(double d, double d2) {
        if (d > 90.0d || d < -90.0d) {
    ...
    private static void m8687b(float f) {
        if (f <= 0.0f) {
    ...
    public static hd m8688h(byte[] bArr) {
