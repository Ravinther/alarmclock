...
public interface hu extends IInterface {
    ...
    public static abstract class C1950a extends Binder implements hu {

        /* renamed from: com.google.android.gms.internal.hu.a.a */
        private static class C1949a implements hu {
            private IBinder kn;
            ...
            public void m8702a(int i, Bundle bundle, int i2, Intent intent) {
        ...
        public static hu aL(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof hu)) ? new C1949a(iBinder) : (hu) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) {
            switch (code) {
                case Base64.NO_PADDING /*1*/:
                    ...
                    m8701a(data.readInt(), data.readInt() != 0 ? (Bundle) Bundle.CREATOR.createFromParcel(data) : null, data.readInt(), data.readInt() != 0 ? (Intent) Intent.CREATOR.createFromParcel(data) : null);
    ...
    void m8701a(int i, Bundle bundle, int i2, Intent intent);
}
