...
public final class ex extends Drawable implements Callback {
    ...
    private static final class C1871a extends Drawable {
        private static final C1871a CK;
        private static final C1870a CL;

        /* renamed from: com.google.android.gms.internal.ex.a.a */
        private static final class C1870a extends ConstantState {
            private C1870a() {
            }
    ...
    static final class C1872b extends ConstantState {
        int CM;
        int CN;

        C1872b(C1872b c1872b) {
            if (c1872b != null) {
                this.CM = c1872b.CM;
                this.CN = c1872b.CN;
            }
    ...
    public ex(Drawable drawable, Drawable drawable2) {
        ...
        C1872b c1872b = this.CD;
        c1872b.CN |= drawable.getChangingConfigurations();
        if (drawable2 == null) {
            drawable2 = C1871a.CK;
        }
        this.CF = drawable2;
        ...
        c1872b = this.CD;
        c1872b.CN |= drawable2.getChangingConfigurations();
    }
