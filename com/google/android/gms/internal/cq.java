...
public class cq implements InAppPurchase {
    ...
    public String getProductId() {
        try {
            ...
            dw.m8215c("Could not forward getProductId to InAppPurchase", e);
            return null;
        }
    }
    ...
    public void recordPlayBillingResolution(int billingResponseCode) {
        try {
            ...
            dw.m8215c("Could not forward recordPlayBillingResolution to InAppPurchase", e);
        }
    }
    ...
    public void recordResolution(int resolution) {
        try {
            ...
            dw.m8215c("Could not forward recordResolution to InAppPurchase", e);
        }
    }
}
