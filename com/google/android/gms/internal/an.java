...
public final class an {
    ...
    public an(Context context, AttributeSet attributeSet) {
        int i = 1;
        TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C1336R.styleable.AdsAttrs);
        ...
        if (i2 != 0 && r1 == 0) {
            this.lW = m7835f(string);
        } else if (i2 == 0 && r1 != 0) {
            this.lW = m7835f(string2);
        } else if (i2 == 0 || r1 == 0) {
    ...
    private static AdSize[] m7835f(String str) {
    ...
    public AdSize[] m7836e(boolean z) {
