...
public class cc extends C1793a {
    private dz lC;
    ...
    class C17891 implements C1739a {
        ...
        public void m8019a(dz dzVar) {
            dzVar.bG();
        }
    }

    /* renamed from: com.google.android.gms.internal.cc.a */
    private static final class C1790a extends Exception {
    ...
    private static final class C1791b extends RelativeLayout {
        private final dr kF;

        public C1791b(Context context, String str) {
            super(context);
    ...
    private static final class C1792c {
        ...
        public C1792c(dz dzVar) {
            ...
            throw new C1790a("Could not get the parent of the WebView for an overlay.");
        }
    }
    ...
    private static RelativeLayout.LayoutParams m8022a(int i, int i2, int i3, int i4) {
    ...
    private void m8024j(boolean z) {
        ...
        if (VERSION.SDK_INT >= 11) {
            dw.m8217v("Enabling hardware acceleration on the AdActivity window.");
            ds.m8200a(window);
        }
        this.oc = new C1791b(this.nS, this.nT.or);
        this.oc.setBackgroundColor(-16777216);
        this.nS.setContentView(this.oc);
        m8025N();
        boolean bP = this.nT.oj.bI().bP();
        if (z) {
            this.lC = dz.m8225a(this.nS, this.nT.oj.m8226R(), true, bP, null, this.nT.kK);
            this.lC.bI().m8243a(null, null, this.nT.ok, this.nT.oo, true, this.nT.oq);
            this.lC.bI().m8242a(new C17891(this));
            if (this.nT.nO != null) {
                this.lC.loadUrl(this.nT.nO);
            } else if (this.nT.on != null) {
                this.lC.loadDataWithBaseURL(this.nT.ol, this.nT.on, "text/html", "UTF-8", null);
            } else {
                throw new C1790a("No URL or HTML to display in ad overlay.");
            }
        }
        this.lC = this.nT.oj;
    ...
    public void m8026a(View view, CustomViewCallback customViewCallback) {
    ...
    public void m8027b(int i, int i2, int i3, int i4) {
        if (this.nU != null) {
            this.nU.setLayoutParams(m8022a(i, i2, i3, i4));
        }
    }

    public void m8028c(int i, int i2, int i3, int i4) {
        if (this.nU == null) {
            this.nU = new cg(this.nS, this.lC);
            this.oc.addView(this.nU, 0, m8022a(i, i2, i3, i4));
            this.lC.bI().m8248q(false);
        }
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.oa = z;
        try {
            this.nT = ce.m8034a(this.nS.getIntent());
            if (this.nT == null) {
                throw new C1790a("Could not get info for ad overlay.");
            }
            if (savedInstanceState == null) {
                if (this.nT.oi != null) {
                    this.nT.oi.m8037W();
            ...
            switch (this.nT.op) {
                ...
                case Base64.CRLF /*4*/:
                    if (this.oa) {
                        this.nS.finish();
                    } else if (!bz.m7958a(this.nS, this.nT.og, this.nT.oo)) {
                        this.nS.finish();
                    }
                default:
                    throw new C1790a("Could not determine ad overlay type.");
            }
        } catch (C1790a e) {
