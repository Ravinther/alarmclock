...
public final class dr {
    ...
    class C18301 implements OnClickListener {
        final /* synthetic */ String rm;
        final /* synthetic */ dr rn;

        C18301(dr drVar, String str) {
            this.rn = drVar;
            this.rm = str;
        }
    ...
    private void m8196a(int i, float f, float f2) {
        if (i == 0) {
            this.mState = 0;
            this.rj = f;
            this.rk = f2;
    ...
    private void showDialog() {
        ...
        builder.setPositiveButton("Share", new C18301(this, obj));
        builder.setNegativeButton("Close", new C18312(this));
        builder.create().show();
    }

    public void m8197c(MotionEvent motionEvent) {
        int historySize = motionEvent.getHistorySize();
        for (int i = 0; i < historySize; i++) {
            m8196a(motionEvent.getActionMasked(), motionEvent.getHistoricalX(0, i), motionEvent.getHistoricalY(0, i));
        }
        m8196a(motionEvent.getActionMasked(), motionEvent.getX(), motionEvent.getY());
    }

    public void m8198t(String str) {
        this.rh = str;
    }
}
