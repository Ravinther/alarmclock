...
public class gu extends C1586h {
    ...
    protected /* synthetic */ Object m8612b(DataHolder dataHolder, int i, int i2) {
        return m8613j(dataHolder, i, i2);
    }

    protected DriveId m8613j(DataHolder dataHolder, int i, int i2) {
