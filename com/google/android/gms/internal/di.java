...
public class di {
    ...
    private static final class C1824a {
        private long qH;
        private long qI;
    ...
    public void bm() {
        synchronized (this.li) {
            if (!(this.qG == -1 || this.qy.isEmpty())) {
                C1824a c1824a = (C1824a) this.qy.getLast();
                if (c1824a.bn() == -1) {
                    c1824a.bo();
                    this.qx.m8162a(this);
                }
    ...
    public void m8155f(ah ahVar) {
        synchronized (this.li) {
            this.qF = SystemClock.elapsedRealtime();
            dj djVar = this.qx;
            dj.bu().m8166b(ahVar, this.qF);
        }
    }

    public void m8156h(long j) {
        synchronized (this.li) {
            this.qG = j;
            if (this.qG != -1) {
                this.qx.m8162a(this);
    ...
    public Bundle toBundle() {
        ...
        synchronized (this.li) {
            ...
            while (it.hasNext()) {
                arrayList.add(((C1824a) it.next()).toBundle());
            }
