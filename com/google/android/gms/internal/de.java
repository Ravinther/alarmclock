...
public final class de {
    ...
    class C18221 implements bb {
        ...
        public void m8129b(dz dzVar, Map map) {
            synchronized (this.pM.li) {
                String str = (String) map.get("errors");
                dw.m8221z("Invalid " + ((String) map.get("type")) + " request error: " + str);
                this.pM.oS = 1;
                this.pM.li.notify();
            }
        }
    ...
    class C18232 implements bb {
        ...
        public void m8130b(dz dzVar, Map map) {
            synchronized (this.pM.li) {
                String str = (String) map.get(PlusShare.KEY_CALL_TO_ACTION_URL);
                if (str == null) {
                    dw.m8221z("URL missing in loadAdUrl GMSG.");
                    return;
                }
                if (str.contains("%40mediation_adapters%40")) {
                    str = str.replaceAll("%40mediation_adapters%40", dn.m8170b(dzVar.getContext(), (String) map.get("check_adapters"), this.pM.pI));
                    dw.m8220y("Ad request URL modified to " + str);
                }
                this.pM.pJ = str;
                this.pM.li.notify();
            }
    ...
    public de(String str) {
        this.li = new Object();
        this.oS = -2;
        this.pK = new C18221(this);
        this.pL = new C18232(this);
        this.pI = str;
    }

    public void m8135b(dz dzVar) {
    ...
    L_0x0012:
        ...
        com.google.android.gms.internal.dw.m8221z(r0);	 Catch:{ all -> 0x001f }
        r0 = 0;
