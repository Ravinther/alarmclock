...
public class ew {
    ...
    public static String m8396a(Calendar calendar) {
        if (calendar == null) {
            zb.m8388b("Calendar object cannot be null", new Object[0]);
            return null;
        }
        String str = Ad;
    ...
    public static void m8397a(List list, JSONObject jSONObject) {
        try {
            list.clear();
    ...
    public static void m8398a(JSONObject jSONObject, List list) {
    ...
    public static Calendar ac(String str) {
        if (TextUtils.isEmpty(str)) {
            zb.m8388b("Input string is empty or null", new Object[0]);
            return null;
        }
        String ad = ad(str);
        if (TextUtils.isEmpty(ad)) {
            zb.m8388b("Invalid date format", new Object[0]);
            return null;
        }
        String ae = ae(str);
        ...
        try {
            ...
            zb.m8388b("Error parsing string: %s", e.getMessage());
            return null;
        }
    }
    ...
    private static String ad(String str) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            try {
                ...
                zb.m8389c("Error extracting the date: %s", e.getMessage());
            }
        }
        return str2;
    }
    ...
    private static String ae(String str) {
        if (TextUtils.isEmpty(str)) {
            zb.m8388b("string is empty or null", new Object[0]);
            return null;
        }
        int indexOf = str.indexOf(84);
        int i = indexOf + 1;
        if (indexOf != "yyyyMMdd".length()) {
            zb.m8388b("T delimeter is not found", new Object[0]);
            return null;
        }
        try {
            ...
            zb.m8388b("Error extracting the time substring: %s", e.getMessage());
            return null;
        }
    }
