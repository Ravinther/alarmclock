...
import com.google.android.gms.internal.gy.C1932a;
...
public class gw extends ff {
    ...
    public static final class C1929a extends C1928a {
        private final int CV;
        private Activity nS;

        public C1929a(int i, Activity activity) {
            this.CV = i;
            this.nS = activity;
        }
        ...
        public void m8617d(int i, Bundle bundle) {
    ...
    protected gy m8618R(IBinder iBinder) {
        return C1932a.m8625T(iBinder);
    }

    public void m8619a(UserAddressRequest userAddressRequest, int i) {
        hO();
        this.NA = new C1929a(i, this.nS);
        Bundle bundle;
        try {
            bundle = new Bundle();
            ...
            hN().m8623a(this.NA, userAddressRequest, bundle);
        } catch (Throwable e) {
            Log.e("AddressClientImpl", "Exception requesting user address", e);
            bundle = new Bundle();
            bundle.putInt(Extras.EXTRA_ERROR_CODE, ErrorCodes.ERROR_CODE_NO_APPLICABLE_ADDRESSES);
            this.NA.m8617d(1, bundle);
        }
    }

    protected void m8620a(fm fmVar, C1893e c1893e) {
        fmVar.m8463d(c1893e, GooglePlayServicesUtil.GOOGLE_PLAY_SERVICES_VERSION_CODE, getContext().getPackageName());
    }
    ...
    protected /* synthetic */ IInterface m8621r(IBinder iBinder) {
        return m8618R(iBinder);
    }
}
