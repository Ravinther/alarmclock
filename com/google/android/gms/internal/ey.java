...
public final class ey {
    public static Bitmap m8399a(Bitmap bitmap) {
        int i = 0;
        if (bitmap == null) {
            return null;
        }
    ...
    private static Bitmap m8400a(Drawable drawable) {
        if (drawable == null) {
            return null;
        }
    ...
    public static Drawable m8401a(Resources resources, Drawable drawable) {
        return new BitmapDrawable(resources, m8399a(m8400a(drawable)));
    }
}
