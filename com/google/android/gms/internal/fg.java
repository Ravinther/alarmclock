...
public final class fg {
    ...
    final class C1897a extends Handler {
        final /* synthetic */ fg Dt;

        public C1897a(fg fgVar, Looper looper) {
            this.Dt = fgVar;
            super(looper);
        }
    ...
    public fg(Context context, Looper looper, C1465b c1465b) {
        this.Dp = new ArrayList();
        this.Dq = new ArrayList();
        this.Dr = false;
        this.Ds = new ArrayList();
        this.Do = c1465b;
        this.mHandler = new C1897a(this, looper);
    }

    public void m8428O(int i) {
    ...
    public void m8429a(ConnectionResult connectionResult) {
        this.mHandler.removeMessages(1);
    ...
    public void m8430b(android.os.Bundle r6) {
        /*
        r5 = this;
        r1 = 0;
        r0 = 1;
    ...
    L_0x0009:
        r2 = r0;
    L_0x000a:
        com.google.android.gms.internal.fq.m8521x(r2);	 Catch:{ all -> 0x0062 }
    ...
    L_0x001e:
        com.google.android.gms.internal.fq.m8521x(r0);	 Catch:{ all -> 0x0062 }
