...
public final class ak implements SafeParcelable {
    ...
    public ak(Context context, AdSize[] adSizeArr) {
        ...
        if (i4 != 0) {
            this.widthPixels = m7828a(displayMetrics);
            i = (int) (((float) this.widthPixels) / displayMetrics.density);
        } else {
            i2 = this.width;
            this.widthPixels = dv.m8207a(displayMetrics, this.width);
            i = i2;
        }
        i2 = i5 != 0 ? m7830c(displayMetrics) : this.height;
        this.heightPixels = dv.m8207a(displayMetrics, i2);
        if (i4 == 0 && i5 == 0) {
    ...
    public static int m7828a(DisplayMetrics displayMetrics) {
        return displayMetrics.widthPixels;
    }

    public static int m7829b(DisplayMetrics displayMetrics) {
        return (int) (((float) m7830c(displayMetrics)) * displayMetrics.density);
    }

    private static int m7830c(DisplayMetrics displayMetrics) {
        int i = (int) (((float) displayMetrics.heightPixels) / displayMetrics.density);
        return i <= 400 ? 32 : i <= 720 ? 50 : 90;
    }

    public AdSize aA() {
        return C1338a.m5872a(this.width, this.height, this.lS);
    }
