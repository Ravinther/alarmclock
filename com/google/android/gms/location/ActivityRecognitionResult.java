...
public class ActivityRecognitionResult implements SafeParcelable {
    ...
    public ActivityRecognitionResult(int versionCode, List probableActivities, long timeMillis, long elapsedRealtimeMillis) {
        this.xH = 1;
    ...
    public ActivityRecognitionResult(List probableActivities, long time, long elapsedRealtimeMillis) {
        boolean z = probableActivities != null && probableActivities.size() > 0;
        fq.m8519b(z, (Object) "Must have at least 1 detected activity");
        this.xH = 1;
        this.NP = probableActivities;
        this.NQ = time;
        this.NR = elapsedRealtimeMillis;
    ...
    public void writeToParcel(Parcel out, int flags) {
        ActivityRecognitionResultCreator.m9024a(this, out, flags);
    }
}
