...
public class CastDevice implements SafeParcelable {
    ...
    CastDevice(int versionCode, String deviceId, String hostAddress, String friendlyName, String modelName, String deviceVersion, int servicePort, List icons) {
        this.xH = versionCode;
        this.ya = deviceId;
        this.yb = hostAddress;
        if (this.yb != null) {
    ...
    public boolean equals(Object obj) {
        ...
        return getDeviceId() == null ? castDevice.getDeviceId() == null : eo.m8365a(this.ya, castDevice.ya) && eo.m8365a(this.yc, castDevice.yc) && eo.m8365a(this.ye, castDevice.ye) && eo.m8365a(this.yd, castDevice.yd) && eo.m8365a(this.yf, castDevice.yf) && this.yg == castDevice.yg && eo.m8365a(this.yh, castDevice.yh);
    }
    ...
    public boolean isSameDevice(CastDevice castDevice) {
        ...
        if (getDeviceId() == null) {
            ...
            return eo.m8365a(getDeviceId(), castDevice.getDeviceId());
        }
    }
