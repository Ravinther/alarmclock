...
public final class CastMediaControlIntent {
    ...
    private static String m6129a(String str, String str2, Collection collection) {
    ...
    public static String categoryForCast(String applicationId) {
        if (applicationId != null) {
            return m6129a(CATEGORY_CAST, applicationId, null);
        }
    ...
    public static String categoryForCast(String applicationId, Collection namespaces) {
        if (applicationId == null) {
            ...
            return m6129a(CATEGORY_CAST, applicationId, namespaces);
        } else {
    ...
    public static String categoryForCast(Collection namespaces) {
        if (namespaces != null) {
            return m6129a(CATEGORY_CAST, null, namespaces);
        }
        throw new IllegalArgumentException("namespaces cannot be null");
    }

    public static String categoryForRemotePlayback() {
        return m6129a("com.google.android.gms.cast.CATEGORY_CAST_REMOTE_PLAYBACK", null, null);
    }

    public static String categoryForRemotePlayback(String applicationId) {
        if (!TextUtils.isEmpty(applicationId)) {
            return m6129a("com.google.android.gms.cast.CATEGORY_CAST_REMOTE_PLAYBACK", applicationId, null);
        }
