...
public final class ExtendedGameEntity extends GamesDowngradeableSafeParcel implements ExtendedGame {
    ...
    static final class ExtendedGameEntityCreatorCompat extends ExtendedGameEntityCreator {
        ...
        public ExtendedGameEntity aq(Parcel parcel) {
            if (GamesDowngradeableSafeParcel.m6742c(fe.eJ()) || fe.al(ExtendedGameEntity.class.getCanonicalName())) {
    ...
    ExtendedGameEntity(int versionCode, GameEntity game, int availability, boolean owned, int achievementUnlockedCount, long lastPlayedServerTimestamp, long priceMicros, String formattedPrice, long fullPriceMicros, String formattedFullPrice, ArrayList badges) {
        this.xH = versionCode;
        this.Lt = game;
    ...
    static int m7704a(ExtendedGame extendedGame) {
    ...
    static boolean m7705a(ExtendedGame extendedGame, Object obj) {
    ...
    static String m7706b(ExtendedGame extendedGame) {
        return fo.m8511e(extendedGame).m8510a("Game", extendedGame.getGame()).m8510a("Availability", Integer.valueOf(extendedGame.gX())).m8510a("Owned", Boolean.valueOf(extendedGame.gY())).m8510a("AchievementUnlockedCount", Integer.valueOf(extendedGame.gZ())).m8510a("LastPlayedServerTimestamp", Long.valueOf(extendedGame.ha())).m8510a("PriceMicros", Long.valueOf(extendedGame.hb())).m8510a("FormattedPrice", extendedGame.hc()).m8510a("FullPriceMicros", Long.valueOf(extendedGame.hd())).m8510a("FormattedFullPrice", extendedGame.he()).toString();
    }
    ...
    public String toString() {
        return m7706b((ExtendedGame) this);
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        ExtendedGameEntityCreator.m7703a(this, dest, flags);
    }
}
