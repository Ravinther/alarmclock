...
public final class GameRequestCluster implements SafeParcelable, GameRequest {
    ...
    GameRequestCluster(int versionCode, ArrayList requestList) {
        this.xH = versionCode;
        this.LM = requestList;
        hn();
    }
    ...
    private void hn() {
        ...
        for (int i = 1; i < size; i++) {
            ...
            fb.m8418a(gameRequest.getType() == gameRequest2.getType(), "All the requests must be of the same type");
            fb.m8418a(gameRequest.getSender().equals(gameRequest2.getSender()), "All the requests must be from the same sender");
        }
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        GameRequestClusterCreator.m7717a(this, dest, flags);
    }
}
