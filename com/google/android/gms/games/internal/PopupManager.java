...
public class PopupManager {
    ...
    private static final class PopupManagerHCMR1 extends PopupManager implements OnAttachStateChangeListener, OnGlobalLayoutListener {
        ...
        public void m7458g(View view) {
            ...
            if (view == null && (context instanceof Activity)) {
                ...
                GamesLog.m7100g("PopupManager", "You have not specified a View to use as content view for popups. Falling back to the Activity content view which may not work properly in future versions of the API. Use setViewForPopups() to set your content view.");
                view = view2;
            }
            if (view != null) {
                m7457h(view);
            ...
            GamesLog.m7101h("PopupManager", "No content view usable to display popups. Popups will not be displayed in response to this client's calls. Use setViewForPopups() to set your content view.");
        }
    ...
    public static PopupManager m7455a(GamesClientImpl gamesClientImpl, int i) {
    ...
    public void m7456g(View view) {
    }

    public void gS() {
        this.JK.m7014a(this.JL.JM, this.JL.gV());
    }
