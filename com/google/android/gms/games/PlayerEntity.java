...
public final class PlayerEntity extends GamesDowngradeableSafeParcel implements Player {
    ...
    static final class PlayerEntityCreatorCompat extends PlayerEntityCreator {
        ...
        public PlayerEntity ao(Parcel parcel) {
            if (GamesDowngradeableSafeParcel.m6742c(fe.eJ()) || fe.al(PlayerEntity.class.getCanonicalName())) {
    ...
    static int m6755a(Player player) {
    ...
    static boolean m6756a(Player player, Object obj) {
    ...
    static String m6757b(Player player) {
        return fo.m8511e(player).m8510a("PlayerId", player.getPlayerId()).m8510a("DisplayName", player.getDisplayName()).m8510a("IconImageUri", player.getIconImageUri()).m8510a("IconImageUrl", player.getIconImageUrl()).m8510a("HiResImageUri", player.getHiResImageUri()).m8510a("HiResImageUrl", player.getHiResImageUrl()).m8510a("RetrievedTimestamp", Long.valueOf(player.getRetrievedTimestamp())).toString();
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        PlayerEntityCreator.m6754a(this, dest, flags);
    }
}
