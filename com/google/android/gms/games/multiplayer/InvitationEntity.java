...
public final class InvitationEntity extends GamesDowngradeableSafeParcel implements Invitation {
    ...
    static final class InvitationEntityCreatorCompat extends InvitationEntityCreator {
        ...
        public InvitationEntity au(Parcel parcel) {
            if (GamesDowngradeableSafeParcel.m6742c(fe.eJ()) || fe.al(InvitationEntity.class.getCanonicalName())) {
    ...
    InvitationEntity(int versionCode, GameEntity game, String invitationId, long creationTimestamp, int invitationType, ParticipantEntity inviter, ArrayList participants, int variant, int availableAutoMatchSlots) {
        this.xH = versionCode;
        this.Lt = game;
    ...
    InvitationEntity(Invitation invitation) {
        ...
        fq.m8517b(obj, (Object) "Must have a valid inviter!");
        this.Mw = (ParticipantEntity) obj.freeze();
    }

    static int m7733a(Invitation invitation) {
    ...
    static boolean m7734a(Invitation invitation, Object obj) {
    ...
    static String m7735b(Invitation invitation) {
        return fo.m8511e(invitation).m8510a("Game", invitation.getGame()).m8510a("InvitationId", invitation.getInvitationId()).m8510a("CreationTimestamp", Long.valueOf(invitation.getCreationTimestamp())).m8510a("InvitationType", Integer.valueOf(invitation.getInvitationType())).m8510a("Inviter", invitation.getInviter()).m8510a("Participants", invitation.getParticipants()).m8510a("Variant", Integer.valueOf(invitation.getVariant())).m8510a("AvailableAutoMatchSlots", Integer.valueOf(invitation.getAvailableAutoMatchSlots())).toString();
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        InvitationEntityCreator.m7732a(this, dest, flags);
    }
}
