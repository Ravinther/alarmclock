...
public final class RoomConfig {
    ...
    public static final class Builder {
        ...
        private Builder(RoomUpdateListener updateListener) {
            ...
            this.MP = false;
            this.MK = (RoomUpdateListener) fq.m8517b((Object) updateListener, (Object) "Must provide a RoomUpdateListener");
        }

        public Builder addPlayersToInvite(ArrayList playerIds) {
            fq.m8520f(playerIds);
        ...
        public Builder setVariant(int variant) {
            ...
            fq.m8519b(z, (Object) "Variant must be a positive integer or Room.ROOM_VARIANT_ANY");
            this.My = variant;
            return this;
        }
    }
    ...
    private RoomConfig(Builder builder) {
        ...
        if (this.MM == null) {
            fq.m8515a(this.MP, "Must either enable sockets OR specify a message listener");
        }
    }
