...
public final class ParticipantEntity extends GamesDowngradeableSafeParcel implements Participant {
    ...
    static final class ParticipantEntityCreatorCompat extends ParticipantEntityCreator {
        ...
        public ParticipantEntity av(Parcel parcel) {
            Object obj = 1;
            if (GamesDowngradeableSafeParcel.m6742c(fe.eJ()) || fe.al(ParticipantEntity.class.getCanonicalName())) {
    ...
    static int m7738a(Participant participant) {
    ...
    static boolean m7739a(Participant participant, Object obj) {
    ...
    static String m7740b(Participant participant) {
        return fo.m8511e(participant).m8510a("ParticipantId", participant.getParticipantId()).m8510a("Player", participant.getPlayer()).m8510a("Status", Integer.valueOf(participant.getStatus())).m8510a("ClientAddress", participant.gi()).m8510a("ConnectedToRoom", Boolean.valueOf(participant.isConnectedToRoom())).m8510a("DisplayName", participant.getDisplayName()).m8510a("IconImage", participant.getIconImageUri()).m8510a("IconImageUrl", participant.getIconImageUrl()).m8510a("HiResImage", participant.getHiResImageUri()).m8510a("HiResImageUrl", participant.getHiResImageUrl()).m8510a("Capabilities", Integer.valueOf(participant.getCapabilities())).m8510a("Result", participant.getResult()).toString();
    }
    ...
    public String toString() {
        return m7740b((Participant) this);
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        ParticipantEntityCreator.m7737a(this, dest, flags);
    }
}
