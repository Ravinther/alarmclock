...
public final class UserAddressRequest implements SafeParcelable {
    ...
    public final class Builder {
        ...
        public Builder addAllowedCountrySpecifications(Collection countrySpecifications) {
            if (this.Nz.Ny == null) {
                this.Nz.Ny = new ArrayList();
            }
    ...
    UserAddressRequest(int versionCode, List allowedCountrySpecifications) {
        this.xH = versionCode;
