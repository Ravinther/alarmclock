...
public interface C1611c extends IInterface {

    /* renamed from: com.google.android.gms.dynamic.c.a */
    public static abstract class C1612a extends Binder implements C1611c {

        /* renamed from: com.google.android.gms.dynamic.c.a.a */
        private static class C1614a implements C1611c {
            private IBinder kn;

            C1614a(IBinder iBinder) {
                this.kn = iBinder;
            }
            ...
            public void m6730b(C1615d c1615d) {
            ...
            public void m6731c(C1615d c1615d) {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.dynamic.IFragmentWrapper");
            ...
            public C1611c fY() {
                ...
                try {
                    ...
                    obtain2.readException();
                    C1611c J = C1612a.m6726J(obtain2.readStrongBinder());
                    return J;
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        public static C1611c m6726J(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.dynamic.IFragmentWrapper");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C1611c)) ? new C1614a(iBinder) : (C1611c) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) {
            ...
            switch (code) {
                ...
                case MMException.DISPLAY_AD_NOT_READY /*20*/:
                    data.enforceInterface("com.google.android.gms.dynamic.IFragmentWrapper");
                    m6724b(C1617a.m6732K(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                ...
                case 27:
                    data.enforceInterface("com.google.android.gms.dynamic.IFragmentWrapper");
                    m6725c(C1617a.m6732K(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 1598968902:
    ...
    void m6724b(C1615d c1615d);

    void m6725c(C1615d c1615d);
