...
public class PlusOneDummyView extends FrameLayout {
    ...
    private static class C2211a implements C2210d {
        private Context mContext;

        private C2211a(Context context) {
    ...
    private static class C2212b implements C2210d {
        private Context mContext;

        private C2212b(Context context) {
            this.mContext = context;
        }
    ...
    private static class C2213c implements C2210d {
        private Context mContext;

        private C2213c(Context context) {
            this.mContext = context;
        }
    ...
    private C2210d iJ() {
        C2210d c2212b = new C2212b(null);
        if (!c2212b.isValid()) {
            c2212b = new C2213c(null);
        }
        return !c2212b.isValid() ? new C2211a(null) : c2212b;
    }
}
