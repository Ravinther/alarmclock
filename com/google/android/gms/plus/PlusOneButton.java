...
import com.google.android.gms.plus.internal.C2235g;
...
public final class PlusOneButton extends FrameLayout {
    ...
    protected static int getAnnotation(Context context, AttributeSet attrs) {
        String a = ft.m8532a("http://schemas.android.com/apk/lib/com.google.android.gms.plus", "annotation", context, attrs, true, false, "PlusOneButton");
    ...
    protected static int getSize(Context context, AttributeSet attrs) {
        String a = ft.m8532a("http://schemas.android.com/apk/lib/com.google.android.gms.plus", "size", context, attrs, true, false, "PlusOneButton");
    ...
    private void m9181v(Context context) {
        if (this.TT != null) {
            removeView(this.TT);
        }
        this.TT = C2235g.m9266a(context, this.mSize, this.TU, this.ro, this.TV);
        setOnPlusOneClickListener(this.TW);
        addView(this.TT);
    }

    public void initialize(String url, int activityRequestCode) {
        fq.m8515a(getContext() instanceof Activity, "To use this method, the PlusOneButton must be placed in an Activity. Use initialize(String, OnPlusOneClickListener).");
        this.ro = url;
