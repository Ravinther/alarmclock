...
public final class PlusShare {
    ...
    public static class Builder {
        ...
        public Builder(Activity launchingActivity, PlusClient plusClient) {
            ...
            fq.m8515a(plusClient != null, "PlusClient must not be null.");
            fq.m8515a(plusClient.isConnected(), "PlusClient must be connected to create an interactive post.");
            fq.m8515a(plusClient.iI().bg(Scopes.PLUS_LOGIN), "Must request PLUS_LOGIN scope in PlusClient to create an interactive post.");
            Person currentPerson = plusClient.getCurrentPerson();
            this.mIntent.putExtra(PlusShare.EXTRA_SENDER_ID, currentPerson != null ? currentPerson.getId() : ITKSvc.CODEREVISION);
        }
        ...
        public Builder addCallToAction(String label, Uri uri, String deepLinkId) {
            fq.m8515a(this.TZ, "Must include the launching activity with PlusShare.Builder constructor before setting call-to-action");
            boolean z = (uri == null || TextUtils.isEmpty(uri.toString())) ? false : true;
            fq.m8519b(z, (Object) "Must provide a call to action URL");
            ...
            if (!TextUtils.isEmpty(deepLinkId)) {
                fq.m8515a(PlusShare.bd(deepLinkId), "The specified deep-link ID was malformed.");
        ...
        public Intent getIntent() {
            ...
            fq.m8515a(z3, "Call-to-action buttons are only available for URLs.");
            z3 = !booleanExtra || this.mIntent.hasExtra(PlusShare.EXTRA_CONTENT_URL);
            fq.m8515a(z3, "The content URL is required for interactive posts.");
            ...
            fq.m8515a(z, "Must set content URL or content deep-link ID to use a call-to-action button.");
            if (this.mIntent.hasExtra(PlusShare.EXTRA_CONTENT_DEEP_LINK_ID)) {
                fq.m8515a(PlusShare.bd(this.mIntent.getStringExtra(PlusShare.EXTRA_CONTENT_DEEP_LINK_ID)), "The specified deep-link ID was malformed.");
            }
            if (!z2 && equals) {
        ...
        public Builder setContentDeepLinkId(String deepLinkId, String title, String description, Uri thumbnailUri) {
            fq.m8519b(this.TZ, (Object) "Must include the launching activity with PlusShare.Builder constructor before setting deep links");
            fq.m8519b(!TextUtils.isEmpty(deepLinkId), (Object) "The deepLinkId parameter is required.");
            Bundle a = PlusShare.m9182a(title, description, thumbnailUri);
        ...
        public Builder setRecipients(Person user, List recipientList) {
            this.mIntent.putExtra(PlusShare.EXTRA_SENDER_ID, user != null ? user.getId() : ITKSvc.CODEREVISION);
            return setRecipients(recipientList);
        }

        @Deprecated
        public Builder setRecipients(List recipientList) {
    ...
    public static Bundle m9182a(String str, String str2, Uri uri) {
        Bundle bundle = new Bundle();
