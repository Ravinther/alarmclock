...
public final class WalletFragmentInitParams implements SafeParcelable {
    ...
    public final class Builder {
        ...
        public WalletFragmentInitParams build() {
            ...
            fq.m8515a(z2, "Exactly one of MaskedWallet or MaskedWalletRequest is required");
            if (this.acQ.acO < 0) {
                z = false;
            }
            fq.m8515a(z, "masked wallet request code is required and must be non-negative");
            return this.acQ;
        }
