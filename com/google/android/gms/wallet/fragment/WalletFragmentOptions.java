...
public final class WalletFragmentOptions implements SafeParcelable {
    ...
    public static WalletFragmentOptions m9680a(Context context, AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1336R.styleable.WalletFragmentOptions);
        ...
        walletFragmentOptions.acR.m9688I(context);
    ...
    public void m9684I(Context context) {
        if (this.acR != null) {
            this.acR.m9688I(context);
        }
    }
