...
public final class WebImage implements SafeParcelable {
    ...
    public WebImage(JSONObject json) {
        this(m6299d(json), json.optInt(MMLayout.KEY_WIDTH, 0), json.optInt(MMLayout.KEY_HEIGHT, 0));
    }

    private static Uri m6299d(JSONObject jSONObject) {
        Uri uri = null;
