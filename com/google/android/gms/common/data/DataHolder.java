...
public final class DataHolder implements SafeParcelable {
    ...
    public static class Builder {
        ...
        private Builder(String[] columns, String uniqueColumn) {
            this.BH = (String[]) fq.m8520f(columns);
        ...
        private void m6265a(HashMap hashMap) {
        ...
        public Builder sort(String sortColumn) {
            fb.m8419d(sortColumn);
            if (!(this.BT && sortColumn.equals(this.BU))) {
                Collections.sort(this.BQ, new C1471a(sortColumn));
                et();
                this.BT = true;
                this.BU = sortColumn;
            }
        ...
        public Builder withRow(HashMap row) {
            fb.m8419d(row);
            if (this.BR != null) {
                m6265a(row);
            }
    ...
    static class C14701 extends Builder {
        C14701(String[] strArr, String str) {
            super(str, null);
        }
    ...
    private static final class C1471a implements Comparator {
        private final String BV;

        C1471a(String str) {
            this.BV = (String) fq.m8520f(str);
        }

        public int m6268a(HashMap hashMap, HashMap hashMap2) {
            Object f = fq.m8520f(hashMap.get(this.BV));
            Object f2 = fq.m8520f(hashMap2.get(this.BV));
            if (f.equals(f2)) {
                return 0;
            }
        ...
        public /* synthetic */ int compare(Object x0, Object x1) {
            return m6268a((HashMap) x0, (HashMap) x1);
        }
    }

    static {
        CREATOR = new DataHolderCreator();
        BP = new C14701(new String[0], null);
    }
    ...
    public DataHolder(AbstractWindowedCursor cursor, int statusCode, Bundle metadata) {
        this(cursor.getColumnNames(), m6269a(cursor), statusCode, metadata);
    }

    private DataHolder(Builder builder, int statusCode, Bundle metadata) {
        this(builder.BH, m6270a(builder, -1), statusCode, metadata);
    }

    private DataHolder(Builder builder, int statusCode, Bundle metadata, int maxResults) {
        this(builder.BH, m6270a(builder, maxResults), statusCode, metadata);
    }
    ...
    public DataHolder(String[] columns, CursorWindow[] windows, int statusCode, Bundle metadata) {
        ...
        this.xH = 1;
        this.BH = (String[]) fq.m8520f(columns);
        this.BJ = (CursorWindow[]) fq.m8520f(windows);
        this.Ah = statusCode;
        this.BK = metadata;
        validateContents();
    }

    private static CursorWindow[] m6269a(AbstractWindowedCursor abstractWindowedCursor) {
        int i;
    ...
    private static CursorWindow[] m6270a(Builder builder, int i) {
        int size;
        int i2 = 0;
    ...
    public static Builder builder(String[] columns, String uniqueColumn) {
        fq.m8520f(uniqueColumn);
        return new Builder(uniqueColumn, null);
    }

    private void m6271e(String str, int i) {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        DataHolderCreator.m6274a(this, dest, flags);
    }
}
