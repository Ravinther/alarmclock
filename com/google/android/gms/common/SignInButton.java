...
public final class SignInButton extends FrameLayout implements OnClickListener {
    ...
    private static Button m6223a(Context context, int i, int i2) {
        Button fsVar = new fs(context);
        fsVar.m8531a(context.getResources(), i, i2);
        return fsVar;
    }

    private void m6224v(Context context) {
        if (this.Aw != null) {
            removeView(this.Aw);
        }
        try {
            this.Aw = fr.m8523b(context, this.mSize, this.Av);
        } catch (C1619a e) {
            Log.w("SignInButton", "Sign in button not found, using placeholder instead");
            this.Aw = m6223a(context, this.mSize, this.Av);
        }
        addView(this.Aw);
    ...
    public void setStyle(int buttonSize, int colorScheme) {
        ...
        fq.m8515a(z2, "Unknown button size " + buttonSize);
        if (colorScheme < 0 || colorScheme >= SIZE_ICON_ONLY) {
            z = false;
        }
        fq.m8515a(z, "Unknown color scheme " + colorScheme);
