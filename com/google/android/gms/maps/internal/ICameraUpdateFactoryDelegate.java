...
public interface ICameraUpdateFactoryDelegate extends IInterface {
    ...
    public static abstract class C2114a extends Binder implements ICameraUpdateFactoryDelegate {

        /* renamed from: com.google.android.gms.maps.internal.ICameraUpdateFactoryDelegate.a.a */
        private static class C2113a implements ICameraUpdateFactoryDelegate {
            private IBinder kn;

            C2113a(IBinder iBinder) {
                this.kn = iBinder;
            }
            ...
            public C1615d newCameraPosition(CameraPosition cameraPosition) {
            ...
            public C1615d newLatLng(LatLng latLng) {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.ICameraUpdateFactoryDelegate");
            ...
            public C1615d newLatLngBounds(LatLngBounds bounds, int padding) {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.ICameraUpdateFactoryDelegate");
            ...
            public C1615d newLatLngBoundsWithSize(LatLngBounds bounds, int width, int height, int padding) {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.ICameraUpdateFactoryDelegate");
            ...
            public C1615d newLatLngZoom(LatLng latLng, float zoom) {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.ICameraUpdateFactoryDelegate");
            ...
            public C1615d scrollBy(float xPixel, float yPixel) {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.ICameraUpdateFactoryDelegate");
            ...
            public C1615d zoomBy(float amount) {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.ICameraUpdateFactoryDelegate");
            ...
            public C1615d zoomByWithFocus(float amount, int screenFocusX, int screenFocusY) {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.ICameraUpdateFactoryDelegate");
            ...
            public C1615d zoomTo(float zoom) {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.internal.ICameraUpdateFactoryDelegate");
        ...
        public static ICameraUpdateFactoryDelegate m9065Z(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ICameraUpdateFactoryDelegate)) ? new C2113a(iBinder) : (ICameraUpdateFactoryDelegate) queryLocalInterface;
        }
    ...
    C1615d newCameraPosition(CameraPosition cameraPosition);

    C1615d newLatLng(LatLng latLng);

    C1615d newLatLngBounds(LatLngBounds latLngBounds, int i);

    C1615d newLatLngBoundsWithSize(LatLngBounds latLngBounds, int i, int i2, int i3);

    C1615d newLatLngZoom(LatLng latLng, float f);

    C1615d scrollBy(float f, float f2);

    C1615d zoomBy(float f);

    C1615d zoomByWithFocus(float f, int i, int i2);

    C1615d zoomIn();

    C1615d zoomOut();

    C1615d zoomTo(float f);
}
