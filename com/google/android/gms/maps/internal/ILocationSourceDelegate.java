...
import com.google.android.gms.maps.internal.C2141h.C2143a;
import com.mopub.mobileads.util.Base64;

public interface ILocationSourceDelegate extends IInterface {

    /* renamed from: com.google.android.gms.maps.internal.ILocationSourceDelegate.a */
    public static abstract class C2077a extends Binder implements ILocationSourceDelegate {

        /* renamed from: com.google.android.gms.maps.internal.ILocationSourceDelegate.a.a */
        private static class C2117a implements ILocationSourceDelegate {
            private IBinder kn;

            C2117a(IBinder iBinder) {
                this.kn = iBinder;
            }
        ...
        public static ILocationSourceDelegate ae(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ILocationSourceDelegate)) ? new C2117a(iBinder) : (ILocationSourceDelegate) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) {
            switch (code) {
                case Base64.NO_PADDING /*1*/:
                    ...
                    activate(C2143a.ak(data.readStrongBinder()));
