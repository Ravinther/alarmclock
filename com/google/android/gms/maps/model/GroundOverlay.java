...
public final class GroundOverlay {
    private final C2179c SP;

    public GroundOverlay(C2179c delegate) {
        this.SP = (C2179c) fq.m8520f(delegate);
    }
    ...
    public boolean equals(Object other) {
        ...
        try {
            return this.SP.m9141a(((GroundOverlay) other).SP);
