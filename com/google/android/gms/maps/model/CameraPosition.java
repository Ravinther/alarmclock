...
public final class CameraPosition implements SafeParcelable {
    ...
    CameraPosition(int versionCode, LatLng target, float zoom, float tilt, float bearing) {
        fq.m8517b((Object) target, (Object) "null camera target");
        boolean z = 0.0f <= tilt && tilt <= 90.0f;
        fq.m8519b(z, (Object) "Tilt needs to be between 0 and 90 inclusive");
        this.xH = versionCode;
        this.target = target;
        this.zoom = zoom;
        this.tilt = tilt + 0.0f;
    ...
    public String toString() {
        return fo.m8511e(this).m8510a("target", this.target).m8510a("zoom", Float.valueOf(this.zoom)).m8510a("tilt", Float.valueOf(this.tilt)).m8510a("bearing", Float.valueOf(this.bearing)).toString();
    }

    public void writeToParcel(Parcel out, int flags) {
        if (C2157v.iB()) {
            C2162a.m9125a(this, out, flags);
        } else {
            CameraPositionCreator.m9099a(this, out, flags);
        }
    }
}
