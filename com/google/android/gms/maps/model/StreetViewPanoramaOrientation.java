...
public class StreetViewPanoramaOrientation implements SafeParcelable {
    ...
    public String toString() {
        return fo.m8511e(this).m8510a("tilt", Float.valueOf(this.tilt)).m8510a("bearing", Float.valueOf(this.bearing)).toString();
    }

    public void writeToParcel(Parcel out, int flags) {
        StreetViewPanoramaOrientationCreator.m9118a(this, out, flags);
    }
}
