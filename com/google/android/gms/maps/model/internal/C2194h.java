...
public interface C2194h extends IInterface {

    /* renamed from: com.google.android.gms.maps.model.internal.h.a */
    public static abstract class C2196a extends Binder implements C2194h {

        /* renamed from: com.google.android.gms.maps.model.internal.h.a.a */
        private static class C2195a implements C2194h {
            private IBinder kn;

            C2195a(IBinder iBinder) {
                this.kn = iBinder;
            }

            public boolean m9157a(C2194h c2194h) {
                boolean z = false;
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
                    obtain.writeStrongBinder(c2194h != null ? c2194h.asBinder() : null);
        ...
        public static C2194h aJ(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C2194h)) ? new C2195a(iBinder) : (C2194h) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) {
            ...
            switch (code) {
                ...
                case Base64.URL_SAFE /*8*/:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
                    isVisible = m9156a(C2196a.aJ(data.readStrongBinder()));
                    reply.writeNoException();
                    if (isVisible) {
                        i = 1;
                    }
