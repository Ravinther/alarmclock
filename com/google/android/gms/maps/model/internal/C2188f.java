...
public interface C2188f extends IInterface {

    /* renamed from: com.google.android.gms.maps.model.internal.f.a */
    public static abstract class C2190a extends Binder implements C2188f {

        /* renamed from: com.google.android.gms.maps.model.internal.f.a.a */
        private static class C2189a implements C2188f {
            private IBinder kn;
            ...
            public boolean m9152h(C2188f c2188f) {
                boolean z = false;
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
            ...
            public void m9153l(C1615d c1615d) {
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.maps.model.internal.IMarkerDelegate");
        ...
        public static C2188f aG(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.maps.model.internal.IMarkerDelegate");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof C2188f)) ? new C2189a(iBinder) : (C2188f) queryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) {
            ...
            switch (code) {
                ...
                case Base64.NO_CLOSE /*16*/:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IMarkerDelegate");
                    isDraggable = m9150h(C2190a.aG(data.readStrongBinder()));
                    reply.writeNoException();
                    if (isDraggable) {
                        i = 1;
                    }
                ...
                case C1087k.ActionBar_itemPadding /*18*/:
                    data.enforceInterface("com.google.android.gms.maps.model.internal.IMarkerDelegate");
                    m9151l(C1617a.m6732K(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
