...
public class StreetViewPanoramaCamera implements SafeParcelable {
    ...
    StreetViewPanoramaCamera(int versionCode, float zoom, float tilt, float bearing) {
        ...
        fq.m8519b(z, (Object) "Tilt needs to be between -90 and 90 inclusive");
        this.xH = versionCode;
        this.zoom = zoom;
        this.tilt = 0.0f + tilt;
    ...
    public String toString() {
        return fo.m8511e(this).m8510a("zoom", Float.valueOf(this.zoom)).m8510a("tilt", Float.valueOf(this.tilt)).m8510a("bearing", Float.valueOf(this.bearing)).toString();
    }

    public void writeToParcel(Parcel out, int flags) {
        StreetViewPanoramaCameraCreator.m9115a(this, out, flags);
    }
}
