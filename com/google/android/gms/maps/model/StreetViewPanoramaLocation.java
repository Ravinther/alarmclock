...
public class StreetViewPanoramaLocation implements SafeParcelable {
    ...
    public String toString() {
        return fo.m8511e(this).m8510a("panoId", this.panoId).m8510a("position", this.position.toString()).toString();
    }

    public void writeToParcel(Parcel out, int flags) {
        StreetViewPanoramaLocationCreator.m9117a(this, out, flags);
    }
}
