...
public final class CameraUpdateFactory {
    ...
    static void m9030a(ICameraUpdateFactoryDelegate iCameraUpdateFactoryDelegate) {
        if (Ro == null) {
            Ro = (ICameraUpdateFactoryDelegate) fq.m8520f(iCameraUpdateFactoryDelegate);
        }
    }

    private static ICameraUpdateFactoryDelegate ie() {
        return (ICameraUpdateFactoryDelegate) fq.m8517b(Ro, (Object) "CameraUpdateFactory is not initialized");
    }
