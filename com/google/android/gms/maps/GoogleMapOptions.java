...
public final class GoogleMapOptions implements SafeParcelable {
    ...
    GoogleMapOptions(int versionCode, byte zOrderOnTop, byte useViewLifecycleInFragment, int mapType, CameraPosition camera, byte zoomControlsEnabled, byte compassEnabled, byte scrollGesturesEnabled, byte zoomGesturesEnabled, byte tiltGesturesEnabled, byte rotateGesturesEnabled) {
        this.RK = -1;
        this.xH = versionCode;
        this.RI = C2132a.m9066a(zOrderOnTop);
        this.RJ = C2132a.m9066a(useViewLifecycleInFragment);
        this.RK = mapType;
        this.RL = camera;
        this.RM = C2132a.m9066a(zoomControlsEnabled);
        this.RN = C2132a.m9066a(compassEnabled);
        this.RO = C2132a.m9066a(scrollGesturesEnabled);
        this.RP = C2132a.m9066a(zoomGesturesEnabled);
        this.RQ = C2132a.m9066a(tiltGesturesEnabled);
        this.RR = C2132a.m9066a(rotateGesturesEnabled);
    }
    ...
    public static GoogleMapOptions createFromAttributes(Context context, AttributeSet attrs) {
        ...
        TypedArray obtainAttributes = context.getResources().obtainAttributes(attrs, C1336R.styleable.MapAttrs);
    ...
    byte ii() {
        return C2132a.m9067c(this.RM);
    }

    byte ij() {
        return C2132a.m9067c(this.RN);
    }

    byte ik() {
        return C2132a.m9067c(this.RO);
    }
    ...
    byte im() {
        return C2132a.m9067c(this.RQ);
    }

    byte in() {
        return C2132a.m9067c(this.RR);
    }
    ...
    public void writeToParcel(Parcel out, int flags) {
        if (C2157v.iB()) {
            C2112a.m9064a(this, out, flags);
        } else {
            GoogleMapOptionsCreator.m9052a(this, out, flags);
        }
    }
