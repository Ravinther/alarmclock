...
public final class AdSize {
    ...
    public int getHeightInPixels(Context context) {
        return this.ks == AUTO_HEIGHT ? ak.m7829b(context.getResources().getDisplayMetrics()) : dv.m8206a(context, this.ks);
    }
    ...
    public int getWidthInPixels(Context context) {
        return this.kr == FULL_WIDTH ? ak.m7828a(context.getResources().getDisplayMetrics()) : dv.m8206a(context, this.kr);
    }
