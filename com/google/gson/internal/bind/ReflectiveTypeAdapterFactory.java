...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
    ...
    class C24181 extends BoundField {
        ...
        C24181(String x0, boolean x1, boolean x2, Gson gson, TypeToken typeToken, Field field, boolean z) {
    ...
    private BoundField createBoundField(Gson context, Field field, String name, TypeToken fieldType, boolean serialize, boolean deserialize) {
        return new C24181(name, serialize, deserialize, context, fieldType, field, Primitives.isPrimitive(fieldType.getRawType()));
    }
