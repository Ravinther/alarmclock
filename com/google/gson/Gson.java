...
public final class Gson {
    ...
    class C23841 extends ThreadLocal {
        C23841() {
        }
    ...
    class C23852 implements JsonDeserializationContext {
        C23852() {
        }
    ...
    class C23863 implements JsonSerializationContext {
        C23863() {
        }
    ...
    class C23874 extends TypeAdapter {
        C23874() {
        }
    ...
    class C23885 extends TypeAdapter {
        C23885() {
        }
    ...
    class C23896 extends TypeAdapter {
        C23896() {
        }
    ...
    Gson(Excluder excluder, FieldNamingStrategy fieldNamingPolicy, Map instanceCreators, boolean serializeNulls, boolean complexMapKeySerialization, boolean generateNonExecutableGson, boolean htmlSafe, boolean prettyPrinting, boolean serializeSpecialFloatingPointValues, LongSerializationPolicy longSerializationPolicy, List typeAdapterFactories) {
        this.calls = new C23841();
        this.typeTokenCache = Collections.synchronizedMap(new HashMap());
        this.deserializationContext = new C23852();
        this.serializationContext = new C23863();
